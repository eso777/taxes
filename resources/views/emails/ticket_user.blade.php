    ...
    <tr>
        <td class="container">
            <table>
                <tr>
                    <td>
                        <h1><img src="{{Url('/')}}/front/images/logo.png"><br>
                           New Replay has been submited to your ticket :<a href="{{Url('/dashboard/ticket/'.$tic_id)}}"> #{{$tic_id }} </a></h1>
                    </td>
                </tr>
            </table>
        </td>
                ...
                <tr>
                    <td>
                        ...
                        <ul>
                            ...
                            <li><a href="{{Url('/')}}/aboutComp">About Us</a></li>
                            <li><a href="{{Url('/')}}/ourServies">Services</a></li>
